...
function showFallback(container) {
  ...
  fallback.className = 'floating-lines-fallback';
  fallback.setAttribute('aria-hidden', 'true');
  container.appendChild(fallback);
}

export function mountFloatingLines(container, props = {}) {
  const {
    linesGradient,
  ...
  wrapper.className = 'floating-lines-container';
  wrapper.style.mixBlendMode = mixBlendMode;
  ...
  try {
    ...
    console.warn('FloatingLines: WebGL unavailable, using static fallback.', error);
    dispose();
    showFallback(container);
    return () => {
      container.replaceChildren();
