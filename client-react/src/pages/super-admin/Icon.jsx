// Ports the ICONS svg-path map from client/super-admin/shell.js into a small React component.
const PATHS = {
  ...
  plug: <path d="M22 9.5 16.5 4 14 6.5l1.5 1.5L11 12.5 8.5 10 6 12.5 4 10.5 2 12.5l2 2-3 3 2 2 3-3 2 2 2.5-2.5-2.5-2.5L15.5 9l1.5 1.5L19.5 8 22 9.5z"></path>,
...
export default function Icon({ name, className = 'h-[17px] w-[17px]' }) {
  return (
